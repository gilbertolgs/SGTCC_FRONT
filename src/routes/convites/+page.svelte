            ...
            <tbody>
                ...
                <tr class="trComponent text-text-secondary">
                    ...
                    <th class="flex border-b text-text-primary">
                        <button class="p-4 bg-green-500 hover:scale-110 transition-all rounded-l-md font-bold hover:brightness-90" onclick={() => {responderConvite(convite.id, 1)}}>Aceitar</button>
                        <button class="p-4 mr-1 bg-red-500 hover:scale-110 transition-all rounded-r-md font-bold hover:brightness-90" onclick={() => {responderConvite(convite.id, 2)}}>Rejeitar</button>
                    </th>
                </tr>
                {/each}
            </tbody>
